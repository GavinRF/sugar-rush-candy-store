    ...
    return <div>
      ...
      <div className="bg-off-white pv4">
        <div className="mw7 center ph3 pt4">
          {values.map(({text, heading, imageUrl, imageAlt}, i) =>
            <MediaBlock key={i} text={text} heading={heading} imageUrl={imageUrl} imageAlt={imageAlt} reverse={i % 2 === 0} />
          )}
        </div>
      </div>
    </div>;
